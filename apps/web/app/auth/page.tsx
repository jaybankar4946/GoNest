  ...
  return(
    <div style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',padding:24}}>
      <div style={{width:'100%',maxWidth:360}}>
        ...
        <button onClick={()=>{setMode(m=>m==='password'?'magic':'password');setMsg(null);}} style={{width:'100%',padding:'11px',borderRadius:9999,fontSize:13,fontWeight:500,color:'#111',border:'1px solid #111',background:'#fff',cursor:'pointer'}}>{mode==='password'?'Continue with magic link':'Continue with password'}</button>
